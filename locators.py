...
class OrangeHRMLocators:
    ...
    # PIM Page Locators
    pim_menu = (By.XPATH, "//span[@class='oxd-text oxd-text--span oxd-main-menu-item--name' and text()='PIM']") #//span[@class='oxd-text oxd-text--span oxd-main-menu-item--name' and text()='PIM']
    add_employee_button = (By.XPATH, "//a[@class='oxd-topbar-body-nav-tab-item' and text()='Add Employee']") #//a[@class='oxd-topbar-body-nav-tab-item' and text()='Add Employee']
    ...
    employee_list_button = (By.XPATH, "//a[@class='oxd-topbar-body-nav-tab-item' and text()='Employee List']") #//a[@class='oxd-topbar-body-nav-tab-item' and text()='Employee List']
